      ...
      return (
        ...
        <section className='relative'>
          <section className='grid-container'>
            ...
            <div className="cell medium-6 large-6 small-12">
            <img src={main} alt='On The Case' /></div>
            </div>
            </section>
            </section>
            ...
            <div className="grid-x grid-margin-x">
            <div className="cell medium-6 large-6 small-12">
            <img src={ai} alt='On The Case' /></div>
            <div className="cell medium-6 large-6 small-12">
            <div className='boxCenter'>
            ...
            <div className="cell medium-6 large-6 small-12">
            <img src={report} alt='On The Case' /></div>
            </div>
            </section>
            </section>
            <section className='white-bg'>
            ...
            <div className="grid-x grid-margin-x">
            <div className="cell medium-6 large-6 small-12">
            <img src={client} alt='On The Case' /></div>
            <div className="cell medium-6 large-6 small-12">
              <div className='boxCenter'>
                <div>
...
export default connect()(FeaturesDescription);
