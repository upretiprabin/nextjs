...
$.FroalaEditor.PLUGINS.audio = function(editor) {
...
$.FroalaEditor.DefineIcon("insertAudio", { NAME: "volume-up" });
...
$.FroalaEditor.DefineIcon("audioByURL", { NAME: "link" });
...
$.FroalaEditor.DefineIcon("audioUpload", { NAME: "upload" });
...
$.FroalaEditor.DefineIcon("audioAlignLeft", { NAME: "align-left" });
$.FroalaEditor.DefineIcon("audioAlignRight", { NAME: "align-right" });
// For consistency with the video plugin, we use the align-justify icon for alignCenter. :(
$.FroalaEditor.DefineIcon("audioAlignCenter", { NAME: "align-justify" });

$.FroalaEditor.DefineIcon("audioAlign", { NAME: "align-center" });
$.FroalaEditor.RegisterCommand("audioAlign", {
  type: "dropdown",
  title: "Align",
  options: {
    left: "Align Left",
  ...
  html() {
    ...
    return `<ul class="fr-dropdown-list" role="presentation">
                ${_.map($.FroalaEditor.COMMANDS.audioAlign.options, mkOption).join("\n")}
            </ul>`;
  },
  callback(cmd, val) {
...
$.FroalaEditor.DefineIcon("audioAutoplay", { NAME: "play-circle" });
$.FroalaEditor.RegisterCommand("audioAutoplay", {
  title: "Autoplay",
  toggle: true,
  callback() {
    this.audio.autoplay();
...
$.FroalaEditor.DefineIcon("audioReplace", { NAME: "exchange" });
$.FroalaEditor.RegisterCommand("audioReplace", {
  title: "Replace",
  undo: false,
  focus: false,
  popup: true,
...
$.FroalaEditor.DefineIcon("audioRemove", { NAME: "trash" });
$.FroalaEditor.RegisterCommand("audioRemove", {
  title: "Remove",
  callback() {
    this.audio.remove();
  }
...
$.FroalaEditor.DefineIcon("audioBack", { NAME: "arrow-left" });
$.FroalaEditor.RegisterCommand("audioBack", {
  title: "Back",
  undo: false,
  focus: false,
  back: true,
